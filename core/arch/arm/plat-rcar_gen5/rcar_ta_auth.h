...
#define RSIPM_FW_SHARED_AREA_SIZE	(4096U)
#define RSIPM_FW_SHARED_AREA_ADDR	(TA_VERIFICATION_BASE + \
					TA_VERIFICATION_SIZE - \
					RSIPM_FW_SHARED_AREA_SIZE)
#define TA_CONTENT_CERT_ADDR		(RSIPM_FW_SHARED_AREA_ADDR - \
					RSIPM_FW_SHARED_AREA_SIZE - \
