...
#define QSPI_ONBOARD 0x00200201U
...
/* RPC Clock Frequency Control Register RPCFC[4:0] */
/* HyperFlash read clock 40MHz */
#define RPC_RPCCKCR_40M		(0x00000017U)
/* QSPI Flash read/write clock 80MHz */
#define RPC_RPCCKCR_80M		(0x00000013U)
/* HyperFlash write clock 160MHz */
#define RPC_RPCCKCR_160M	(0x00000011U)

/* PHY control register STRTIM[3:0] */
#define RPC_PHYCNT_STRTIM	(0x08008000U)

/* Data Read Extended Address Setting Register EAC[2:0] */
#define RPC_DREAR_EAC		(0x00000001U)
