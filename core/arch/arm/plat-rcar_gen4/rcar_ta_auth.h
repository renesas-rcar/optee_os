...
#define ICUM_FW_SHARED_AREA_SIZE	(4096U)
#define ICUM_FW_SHARED_AREA_ADDR	(TA_VERIFICATION_BASE + \
					TA_VERIFICATION_SIZE - \
					ICUM_FW_SHARED_AREA_SIZE)
#define TA_CONTENT_CERT_ADDR		(ICUM_FW_SHARED_AREA_ADDR - \
					ICUM_FW_SHARED_AREA_SIZE - \
...
#define RST_MODEMR			(p2v_ioadr(RST_BASE, DEVICE0_SIZE) + 0x0060U)
#define MFIS_SOFTMDR			(p2v_ioadr(MFIS_BASE, MEMORY10_SIZE) + 0x0600U)
#define LCS_SE				(0x5U)
