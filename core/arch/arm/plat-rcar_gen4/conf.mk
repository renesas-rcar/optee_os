...
CFG_STORAGE_KEY_BY_ICUMX_HWENGINE ?= n
ifeq ($(CFG_STORAGE_KEY_BY_ICUMX_HWENGINE), y)
core-platform-cflags += -DRCAR_STORAGE_KEY_BY_ICUMX_HWENGINE
CFG_ICUM_FW_SERVICE := y
core-platform-cflags += -DTARGET_CORTEX_A
core-platform-cflags += -DTARGET_DEVICE_V4H
